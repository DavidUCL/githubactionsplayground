...
const MUTATIONS = [
  ...
  ["courseid: assume 2 instead of deriving it", "scripts/build-preview.mjs",
    ...
    "  return 2;\n  const makers = steps.filter((s) => s.step === \"createCourse\" || s.step === \"restoreCourse\");"],
  ["courseid: accept somebody else's course as the review course",
    "scripts/build-preview.mjs",
    "  if (makers[0].shortname !== COURSE_SHORTNAME) {", "  if (false) {"],
  ["courseid: accept more than one course-creating step", "scripts/build-preview.mjs",
    "  if (makers.length !== 1) {", "  if (false) {"],
